...
const DICT: Record<string, { zh: string; en: string }> = {
  ...
  // 认证面板(AuthPanel):品牌/页签/字段/占位符/按钮/提示/错误
  'auth.brandAlt': { zh: 'AI 教育顾问', en: 'AI Education Advisor' },
  'auth.brandTitle': { zh: 'AI 教育顾问 SaaS 平台', en: 'AI Education Advisor SaaS' },
  'auth.headline1': { zh: '让每家机构', en: 'Every institution' },
  'auth.headline2': { zh: '都有自己的 AI 课程顾问', en: 'deserves its own AI course advisor' },
  'auth.feat1': { zh: '知识域隔离 · RAG 带引用问答', en: 'Domain isolation · RAG with citations' },
  'auth.feat2': { zh: '课程详情 / 班型推荐 Agent Skill', en: 'Course detail / recommendation Agent Skills' },
  'auth.feat3': { zh: '免费版体验 · 标准版 / 旗舰版按需升级', en: 'Free tier · upgrade to Standard / Flagship' },
  'auth.demoLabel': { zh: '演示账号(密码均 demo1234):', en: 'Demo accounts (password demo1234):' },
  'auth.demoList': { zh: 'admin 平台超管 · demo1 旗舰版 · demo2 标准版 · demo3 免费版', en: 'admin platform admin · demo1 Flagship · demo2 Standard · demo3 Free' },
  'auth.backHome': { zh: '← 首页', en: '← Home' },
  'auth.tabSms': { zh: '验证码登录', en: 'SMS Sign In' },
  'auth.tabPassword': { zh: '密码登录', en: 'Password' },
  'auth.tabRegister': { zh: '注册开通', en: 'Sign Up' },
  'auth.fAccount': { zh: '账户名', en: 'Account Name' },
  'auth.fAccountShort': { zh: '账户', en: 'Account' },
  'auth.fPhone': { zh: '手机号', en: 'Phone' },
  'auth.fCode': { zh: '短信验证码', en: 'SMS Code' },
  'auth.phOrgName': { zh: '例如:启明教育培训学校', en: 'e.g. Qiming Education' },
  'auth.phAccount': { zh: '3-24 位字母/数字/下划线,用于密码登录', en: '3-24 letters/digits/_ for password login' },
  'auth.phPasswordReg': { zh: '至少 6 位', en: 'At least 6 chars' },
  'auth.phPhoneReg': { zh: '用于接收验证码与登录', en: 'For SMS code & sign-in' },
  'auth.phPhoneLogin': { zh: '注册时的手机号', en: 'Registered phone number' },
  'auth.phCode': { zh: '6 位验证码', en: '6-digit code' },
  'auth.getCode': { zh: '获取验证码', en: 'Get Code' },
  'auth.resend': { zh: 's 后重发', en: 's to resend' },
  'auth.phAccountLogin': { zh: '账户名或注册手机号', en: 'Username or registered phone' },
  'auth.phPasswordLogin': { zh: '请输入密码', en: 'Enter password' },
  'auth.processing': { zh: '处理中…', en: 'Processing…' },
  'auth.submitRegisterFree': { zh: '注册并开通(免费版)', en: 'Register (Free)' },
  'auth.hintRegister': { zh: '账户名+密码用于密码登录,手机号+验证码用于验证码登录;注册即开通免费版', en: 'Username+password for password login, phone+code for SMS login. Sign up activates the Free plan.' },
  'auth.hintSms': { zh: '未注册的手机号请先切换到「注册开通」页签', en: 'New phone? Switch to the Sign Up tab first' },
  'auth.hintPassword': { zh: '支持账户名或注册手机号登录', en: 'Use username or registered phone' },
  'auth.demoCodeNote': { zh: '演示环境(未接短信网关):本次验证码为', en: 'Demo (no SMS gateway): code is' },
  'auth.errPhone': { zh: '请输入正确的手机号', en: 'Enter a valid phone number' },
  'auth.errOrgName': { zh: '请填写机构名称', en: 'Please enter organization name' },
  'auth.errUser': { zh: '账户名需为 3-24 位字母/数字/下划线/中划线', en: 'Username: 3-24 letters/digits/_/-' },
  'auth.errPass': { zh: '密码至少 6 位', en: 'Password must be 6+ chars' },
  'auth.errCode': { zh: '请填写验证码', en: 'Please enter the code' },
  'auth.errAccountPass': { zh: '请输入账户与密码', en: 'Enter account and password' },
  'auth.errSendFail': { zh: '发送失败', en: 'Send failed' },
  'auth.errReqFail': { zh: '请求失败', en: 'Request failed' },
  'auth.errFallback': { zh: '操作失败,请重试', en: 'Something went wrong, please retry' },
  // 套餐页
